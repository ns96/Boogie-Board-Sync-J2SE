...
public class ServicesSearch {
    ...
    public static UUID OBEX_OBJECT_PUSH_PROFILE = new UUID(0x1105);
    
    /* To find file transfer service */
    public static UUID OBEX_FILE_TRANSFER_PROFILE = new UUID(0x1106);
    
    /* To find hands free service */
    public static UUID HANDS_FREE = new UUID(0x111E);
    
    /* To find SPP Service */
    public static UUID SPP_PROFILE = new UUID(0x1101);
    
    /* Get URL attribute from bluetooth service */
    public static int URL_ATTRIBUTE = 0X0100;
    
    public Map<String, List<String>> getBluetoothDevices() {
        return getBluetoothDevices(SPP_PROFILE);
        //return getBluetoothDevices(OBEX_FILE_TRANSFER_PROFILE);
    }
    
    public Map<String, List<String>> getBluetoothDevices(UUID profileUUID) {        
        /**
        ...
        UUID[] searchUuidSet = new UUID[]{profileUUID};
